...
export const RPC_REQUIRED_SCOPES = {
  ...
  "orchestration.getHandoffText": AuthOrchestrationReadScope,
  "orchestration.getHandoffPlan": AuthOrchestrationReadScope,
  "orchestration.startHelper": AuthOrchestrationOperateScope,
  "orchestration.moveToWorktree": AuthOrchestrationOperateScope,
